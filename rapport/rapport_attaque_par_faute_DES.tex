	 ...
	 \tableofcontents
		...
		\chapter{Application concrète}
			...
			\begin{center}
				\begin{tikzpicture}
				\draw [->](4.4,0) -- (4.4,-0.5);
				\draw (4.4,-1.01) circle (0.5) node {E};
				\draw [->](4.4,-1.5) -- (4.4,-2);
				\draw (4.4,-2.21) circle (0.2);
				\draw (4.4,-2) -- (4.4,-2.40);
				\draw (4.2,-2.20) -- (4.6,-2.20);
				\draw [->](4.4,-2.40) -- (4.4,-2.90);
				\draw (0,-2.91) rectangle (8.8,-3.9);
				\draw (1.1,-2.91) -- (1.1,-3.9);
				\draw (2.2,-2.91) -- (2.2,-3.9);
				\draw (3.3,-2.91) -- (3.3,-3.9);
				\draw (4.4,-2.91) -- (4.4,-3.9);
				\draw (5.5,-2.91) -- (5.5,-3.9);
				\draw (6.6,-2.91) -- (6.6,-3.9);
				\draw (7.7,-2.91) -- (7.7,-3.9);
				
				\draw (0.55,-3.9) -- (0.55,-4.3);
				...
				\draw (0.30,-4.3) rectangle (0.80,-4.8);
				\draw (1.40,-4.3) rectangle (1.9,-4.8);
				\draw (2.5,-4.3) rectangle (3,-4.8);
				\draw (3.60,-4.3) rectangle (4.10,-4.8);
				\draw (4.70,-4.3) rectangle (5.20,-4.8);
				\draw (5.80,-4.3) rectangle (6.30,-4.8);
				\draw (6.90,-4.3) rectangle (7.40,-4.8);
				\draw (8,-4.3) rectangle (8.50,-4.8);
				
				\draw (0.55,-4.8) -- (1.5125,-5.5);
				\draw (1.65,-4.8) -- (2.3375,-5.5);
				\draw (2.75,-4.8) -- (3.1625,-5.5);
				\draw (3.85,-4.8) -- (3.9875,-5.5);
				\draw (4.95,-4.8) -- (4.8125,-5.5);
				\draw (6.05,-4.8) -- (5.6375,-5.5);
				\draw (7.15,-4.8) -- (6.4625,-5.5);
				\draw (8.25,-4.8) -- (7.2875,-5.5);
				
				\draw (1.1,-5.5) rectangle (7.7,-5.9);
				\draw (1.925,-5.5) -- (1.925,-5.9);
				\draw (2.75,-5.5) -- (2.75,-5.9);
				\draw (3.575,-5.5) -- (3.575,-5.9);
				\draw (4.4,-5.5) -- (4.4,-5.9);
				\draw (5.225,-5.5) -- (5.225,-5.9);
				\draw (6.05,-5.5) -- (6.05,-5.9);
				\draw (6.87,-5.5) -- (6.87,-5.9);
				
				\draw [->](4.4,-5.9) -- (4.4,-6.4);
				\draw (4.4,-6.91) circle (0.5) node {P}
				\draw [->](4.4,-7.4) -- (4.4,-7.9);
